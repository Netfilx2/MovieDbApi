package com.sprata.NetfilxCloneCoding_00.MovieApi;
...
//        System.out.println("theMovieApiResponseDto = " + theMovieApiResponseDto.getResults());
    ...
    public TheDramaApiGenreResponseDto TheDramaDBSearchByGenre(DramaGenre genre) throws Exception{
        HttpHeaders httpHeaders = makeHeaders();
        String genreStringId = Integer.toString(genre.getValue());
        ...
        Gson gson = new Gson();
        TheDramaApiGenreResponseDto theDramaApiResponseDto = gson.fromJson(jsonObject.toString(), TheDramaApiGenreResponseDto.class);

//        System.out.println("theMovieApiResponseDto = " + theMovieApiResponseDto.getResults());

        return theDramaApiResponseDto;
    }
...
//        System.out.println("jsonObject = " + jsonObject);
    ...
    public TheMovieApiByIdResponseDto TheDramaDBSearchById(Long id) throws Exception{
        HttpHeaders httpHeaders = makeHeaders();
...
//        System.out.println("jsonObject = " + jsonObject);
    ...
    public static void main(String[] args) throws Exception {
        ...
        movieSearchApi.TheDramaDBSearchByGenre(DramaGenre.Drama);
    }
